...
\resumeItemListStart
\resumeItem{Overview}
{Implemented algorithms in Python supporting recent research in number theory.}
...
Topology, Calculus, Real Analysis}
\resumeSubItem{Graduate}{Logic in CS, Game Theory, Real and Complex Analysis,
Manifolds, Algebra}
