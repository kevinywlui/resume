...
\resumeItem{Link to thesis}{\url{kevinlui.org/pages/thesis}}
\resumeItemListEnd
...
\resumeItem{Link to contributions}{\url{kevinlui.org/pages/code#sagemath}}
...
\url{github.com/williamstein/sage_modabvar} and has since been merged into
...
retrieving and appending missing bibtex entries using either the
