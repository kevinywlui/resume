...
varieties in Python. Most of the effort was spent extracting and translating
algorithms found in research papers to something implementable within the
Sagemath Python library.} 
...
\resumeItem{Primary role}{Guided members through the Sagemath development
process. This includes using developing on Linux, submitting tickets on
\url{https://trac.sagemath.org}, and following the Sagemath developer
conventions.}
\resumeItem{Outcome}{About 6 attendees have made their first open source code
contribution!}
\resumeItemListEnd
...
on pypi. See \url{https://github.com/kevinywlui/caleb}}
