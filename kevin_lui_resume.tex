...
\usepackage{xcolor}
\definecolor{cBlue}{HTML}{364f6b}
\definecolor{cRed}{HTML}{fc5185}
...
% Sections formatting
\titleformat{\section}{
    \vspace{-4pt}\scshape\raggedright\large\color{cBlue}
...
\resumeSubHeadingListStart
\item{
        {Data Structures and Algorithms, Formal
            Languages and Automata, Cryptography, Random Number
        Generation, Computer Theorem Proving, Logic}
    }
\resumeSubHeadingListEnd
