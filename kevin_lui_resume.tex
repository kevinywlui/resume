...
Stein - 3.75 GPA}{June 2019}
% \resumeSubheading
% {University of Washington, Seattle}{Seattle, WA}
% {Masters in Mathematics}{June 2018}
\resumeSubheading
{University of California, Santa Barbara}{Santa Barbara, CA}
{Bachelors in Mathematics - 3.8 GPA}{June 2014}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
            \textbf{Fluent in: }{Python, Git, Sagemath, Latex, Linux as
            a desktop/development environment}
    }
\item{\vspace{-0.15cm}
            \textbf{Prior projects in: }{SQL, Bash, Zsh, C++, MATLAB, Cython}
    }
  \resumeSubHeadingListEnd
...
1-2 hours.}
\resumeItem{Role}{Taught members the Sagemath development process which
includes developing in a Linux environment.}
...
\section{Applied Coursework}
\resumeSubHeadingListStart
\resumeSubItem{Instructor/TA/Grader}{Linear Algebra, Operation Research,
Topology, Calculus}
\resumeSubItem{Graduate}{Logic in CS, Game Theory}
\resumeSubItem{Undergraduate}
{Data Structures and Algorithms, Cryptography, Computer Theorem Proving,
