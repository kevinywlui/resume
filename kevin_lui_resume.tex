...
\resumeSubItem{langclass}{A model for determining the programming language from
    ...
    followed by a gradient boosting classifier. Live-version deployed on AWS
...
\resumeSubHeadingListStart
\resumeSubItem{Instructor/TA/Grader}{Linear Algebra, Operation Research, Calculus}
...
\resumeItem{UW Sagemath Seminar}{Organized a seminar that helped 6 math
...
{Ph.D. in Mathematics specializing in Computational Number Theory - 3.75 GPA}{June 2019}
% \resumeSubheading
% {University of Washington, Seattle}{Seattle, WA}
