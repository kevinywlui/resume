...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    ...
    &
    \faMapO: Seattle, WA (Open to west coast positions)
    \\
...
\item{\vspace{-0.15cm}
            \textbf{Prior projects using: }{SQL, Bash, C++, MATLAB, Cython,
            Numpy}
    }
...
\resumeSubItem{langclass}{A model for determining the programming language from
    its source code. Model uses feature hashing of n-grams followed by a
    gradient boosting tree classifier. Live-version deployed on AWS in a Docker
    container running Flask/Waitress. See \url{http://langclass.kevinlui.org}
    and \url{https://github.com/kevinywlui/langclass}.
}
...
{Volunteer Developer}{May 2016 --- Present}
\resumeItemListStart
\resumeItem{Overview}
...
{Student Developer}{May 2016 --- August 2016}
\resumeItemListStart
\resumeItem{Overview}
{
...
{Undergraduate Summer Researcher}{Jun. 2012 --- August 2016}
\resumeItemListStart
...
{Ph.D. in Mathematics specializing in Computational Number Theory}{Sep. 2014 --- June 2019}
% \resumeSubheading
% {University of Washington, Seattle}{Seattle, WA}
% {Masters in Mathematics}{June 2018}
\resumeSubheading
{University of California, Santa Barbara}{Santa Barbara, CA}
{Bachelors in Mathematics}{Sep. 2010 --- June 2014}
\resumeSubHeadingListEnd
